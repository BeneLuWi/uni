 ...
 *
 * Linear optimal color scale according to Dr. Haim Levkowitz, UMass Lowell (perceptually linearized).
 * See https://ieeexplore.ieee.org/document/135886
 */
class LinearOptimalColorScale {
    static Color map(int i) {
        if (i < 0 || i > 255) {
            throw new IllegalArgumentException("Value i not in range [0,255]");
        }
        return mapping[i];
    }

    private static final Color[] mapping = {
            new Color(0, 0, 0), new Color(0, 0, 0), new Color(0, 0, 0),
            new Color(1, 0, 0), new Color(2, 0, 0), new Color(2, 0, 0),
            new Color(3, 0, 0), new Color(3, 0, 0), new Color(4, 0, 0),
            new Color(5, 0, 0), new Color(5, 0, 0), new Color(6, 0, 0),
            new Color(7, 0, 0), new Color(7, 0, 0), new Color(8, 0, 0),
            new Color(9, 0, 0), new Color(9, 0, 0), new Color(10, 0, 0),
            new Color(11, 0, 0), new Color(12, 0, 0), new Color(13, 0, 0),
            new Color(14, 0, 0), new Color(15, 0, 0), new Color(16, 0, 0),
            new Color(17, 0, 0), new Color(18, 0, 0), new Color(19, 0, 0),
            new Color(20, 0, 0), new Color(21, 0, 0), new Color(22, 0, 0),
            new Color(23, 0, 0), new Color(25, 0, 0), new Color(26, 0, 0),
            new Color(27, 0, 0), new Color(28, 0, 0), new Color(30, 0, 0),
            new Color(31, 0, 0), new Color(33, 0, 0), new Color(34, 0, 0),
            new Color(35, 0, 0), new Color(37, 0, 0), new Color(39, 0, 0),
            new Color(40, 0, 0), new Color(43, 0, 0), new Color(45, 0, 0),
            new Color(46, 0, 0), new Color(49, 0, 0), new Color(51, 0, 0),
            new Color(53, 0, 0), new Color(54, 0, 0), new Color(56, 0, 0),
            new Color(58, 0, 0), new Color(60, 0, 0), new Color(62, 0, 0),
            new Color(64, 0, 0), new Color(67, 0, 0), new Color(69, 0, 0),
            new Color(71, 0, 0), new Color(74, 0, 0), new Color(76, 0, 0),
            new Color(80, 0, 0), new Color(81, 0, 0), new Color(84, 0, 0),
            new Color(86, 0, 0), new Color(89, 0, 0), new Color(92, 0, 0),
            new Color(94, 0, 0), new Color(97, 0, 0), new Color(100, 0, 0),
            new Color(103, 0, 0), new Color(106, 0, 0), new Color(109, 0, 0),
            new Color(112, 0, 0), new Color(115, 0, 0), new Color(117, 0, 0),
            new Color(122, 0, 0), new Color(126, 0, 0), new Color(128, 0, 0),
            new Color(131, 0, 0), new Color(135, 0, 0), new Color(135, 0, 0),
            new Color(135, 1, 0), new Color(135, 2, 0), new Color(135, 3, 0),
            new Color(135, 4, 0), new Color(135, 6, 0), new Color(135, 6, 0),

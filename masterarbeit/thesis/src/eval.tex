...
\end{lstlisting}
 \end{minipage}
 \begin{minipage}{.5\textwidth}
    \begin{lstlisting}[language=C++, caption={[Implementierung mit Intervallen] \\Implementierung mit Intervallen },captionpos=b,xleftmargin=15pt, numbers=left,stepnumber=1,basicstyle=\footnotesize]  
#include "iRRAM.h"
#include "hoTM.h"
using namespace iRRAM;
void compute(){

...
\Abbildungps{tbh}{.8}{img/lyapu.png}{fig:lyapu}{Lokale Annäherung an den Lyapunov Exponenten}{Mehrere Iterationen mit Farbkodierung}  
 ...
 \Abbildungps{tbh}{.8}{img/lyapu_int.png}{fig:lyapuint}{Lokale Annäherung an den Lyapunov Exponenten}{Mehrere Iterationen mit Farbkodierung}  
 
 
 In Abbildung \ref{fig:lyapuint} ist zu sehen, wie sich die Ausbreitung entwickelt, wenn statt zwei Punkten, Intervalle für $x_0$ und $y_0$ mit der Breite $\varepsilon$ verwendet werden; jeweils in Schwarz eingezeichnet.

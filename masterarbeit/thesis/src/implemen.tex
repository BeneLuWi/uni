...
Algorithmus \ref{algo:clean} zeigt eine vereinfachte Darstellung der Cleaning Prozedur.
...
\Return $T'$ \Comment*{$T'$ hat Punktintervalle oder sehr kleine Intervalle auf Zahleneben}

...
"int100"  using 1:2 with lines lt rgb "grey" notitle "Radius x_0 = 2^{-100}",\
"2^-500" using 1:2 with lines lt rgb "#D53E4F" title  "ε = 2^{-500}",\
"tm500" using 1:2 with lines lt rgb "black" notitle "Radius x_0 = = 2^{-500}",\
"int500" using 1:2 with lines lt rgb "grey" notitle "Radius x_0 = = 2^{-500}",\
...
"int1000" using 1:2 with lines lt rgb "grey" notitle "Radius x_0 = = 2^{-1000}",\
...
"int1500" using 1:2 with lines lt rgb "grey" notitle "Radius x_0 = = 2^{-1500}",\
...
"int2000" using 1:2 with lines lt rgb "grey" notitle "Radius x_0 = = 2^{-2000}"
